...
public class EntityGoldenStarFX extends EntityFX {
    public EntityGoldenStarFX(World world, double x, double y, double z, double motionX, double motionY, double motionZ) {
