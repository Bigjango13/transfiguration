...
public class EntityBlueStarFX extends EntityFX {
    public EntityBlueStarFX(World world, double x, double y, double z, double motionX, double motionY, double motionZ) {
